...
def enumerate_database():
	...
	print "[+] Found %d databases." % amount_databases
	...
	target_database = str(raw_input("[*] Enter target database: "))
	...
	if(enumerate_all_tables == "Y"):	
		...
		enumerate_table_keyword = str(raw_input("[?] Do you want to list all tables containing a specific keyword (eg. user, pass, admin)? (Y/N) "))
		if (enumerate_table_keyword == "Y"):
			table_keyword = str(raw_input("[+] Enter keyword: "))
	...
	target_table = raw_input("[?] Enter target table to dump: ")
